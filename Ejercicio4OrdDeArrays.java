package ejercicio4orddearrays;
import java.util.Arrays;

public class Ejercicio4OrdDeArrays {
    ...
    public static void main(String[] args) {
        ...
        int[] copiaSeleccion = pares4.clone();
        ...
        int[] copiaInsercion = pares4.clone();
